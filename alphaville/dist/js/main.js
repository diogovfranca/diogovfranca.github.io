...
jQuery(document).ready(function() {
  ...
  $('.main-pointsInfo .point-19').on('mouseover', function(){
    $('.lg-container .point-19').addClass('active');
  });
  $('.main-pointsInfo .point-19').on('mouseout', function(){
    $('.lg-container .point-19').removeClass('active');
  });

  $('.lg-container .point-19').on('mouseover', function(){
    $('.main-pointsInfo .point-19').addClass('active');
  });
  $('.lg-container .point-19').on('mouseout', function(){
    $('.main-pointsInfo .point-19').removeClass('active');
  });
